                ...
                <form id="form_data">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <label>Group Admin<span style="color: red;">*</span></label>
                            <select class="form-control" name="s_group" id="s_group">
                                <option value="">Pilih Group Admin</option>
                            </select>
                        </div>
                    </div>
                </form>
...
<script src="{{ asset('project/antahassy/admin/js/admin.js?t=').mt_rand() }}"></script>
@endsection